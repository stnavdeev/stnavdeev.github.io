  ...
  <ul style="padding-left: 20px; margin-top: 5px; margin-bottom: 0; font-size: 14px;">
    <li>
      ...
      <div id="abstractPolicy4" style="display: none; margin-top: 5px; margin-left: 0;">
        <p align="justify" style="margin-bottom: 0;">
          We study gender differences in healthcare use, healthcare costs, and chronic conditions among adults in Amsterdam. Using Dutch administrative data and healthcare claims, we compare men and women across primary care, diagnostics, referrals, mental healthcare, hospital care, pharmaceuticals, and selected chronic conditions. Women visit general practitioners 1.5 times more often than men, receive 1.4 times more primary-care diagnostics, and receive 1.6 times more referrals to medical specialists, while the referral rate per general-practice consultation remains similar. Women have 14% higher basic health insurance costs on average, although the age profile differs: women have higher costs below age 60, while men have slightly higher costs after age 60. The largest difference appears at ages 30-39, partly due to maternity care. The project also shows that migraine and thyroid disorders occur more than three times as often among women, whereas men with thyroid disorders follow more intensive hospital trajectories. These patterns show that gender differences in care reflect both health needs and differences in diagnostic and treatment pathways.
        </p>
      </div>
    </li>
  </ul>
