  ...
  <ul style="padding-left: 20px; margin-top: 5px; margin-bottom: 0; font-size: 14px;">
    <li>
      ...
      <div id="abstractPolicy1" style="display: none; margin-top: 5px; margin-left: 0;">
        <p align="justify" style="margin-bottom: 0;">
          This ongoing project studies inequalities in the cardiovascular disease care cascade in Amsterdam. Using CBS microdata and healthcare claims for the adult population, the project examines the prevalence and incidence of treatment for major modifiable cardiovascular risk factors, including hypertension, dyslipidaemia, and type 2 diabetes, alongside major cardiovascular events such as stroke and myocardial infarction. The analyses are stratified by neighbourhood, demographic characteristics, and socioeconomic position in order to document geographic and social variation in disease burden and treatment patterns. The first phase provides a population-level epidemiological overview to inform priority setting, while later phases extend the care cascade framework and support monitoring over time. The project contributes evidence on the distribution of cardiovascular risk and care across Amsterdam.
        </p>
      </div>
    </li>
  </ul>
  ...
  <ul style="padding-left: 20px; margin-top: 5px; margin-bottom: 0; font-size: 14px;">
    <li>
      ...
      <div id="abstractPolicy3" style="display: none; margin-top: 5px; margin-left: 0;">
        <p align="justify" style="margin-bottom: 0;">
          This ongoing project develops a data-driven account of HIV care in the Netherlands from a cost perspective. Using CBS microdata in combination with domain expertise, the project studies the prevalence and distribution of HIV care use, direct HIV-related healthcare expenditure, broader healthcare costs beyond the HIV domain, and societal costs related to labour market position and social participation. The central objective is to establish an empirical baseline for the assessment of future prevention investments, including interventions aimed at reducing new HIV infections. By examining costs and care use across regions and subgroups, the project identifies where burdens are concentrated and where preventive strategies may be most consequential. The resulting evidence is intended to inform further work on HIV prevention and investment.
        </p>
      </div>
    </li>
  </ul>
  ...
  <ul style="padding-left: 20px; margin-top: 5px; margin-bottom: 0; font-size: 14px;">
    <li>
      ...
      <div id="abstractPolicy4" style="display: none; margin-top: 5px; margin-left: 0;">
        <p align="justify" style="margin-bottom: 0;">
          This project studies differences between men and women in healthcare use, healthcare costs, and chronic conditions in Amsterdam. Using CBS microdata and claims-based analyses for the adult population, we examine variation in primary care use, referrals, diagnostics, specialist care, mental healthcare, and selected chronic conditions, while also considering neighbourhood-level and socioeconomic heterogeneity. The findings show that men and women follow different care pathways and exhibit distinct patterns of healthcare use. Women use general practice, diagnostics, and mental healthcare more frequently, while differences in total healthcare costs vary across age groups and care domains. The analyses further indicate that gender differences interact with age, socioeconomic status, migration background, and geography, underscoring the importance of an intersectional perspective.
        </p>
      </div>
    </li>
  </ul>
